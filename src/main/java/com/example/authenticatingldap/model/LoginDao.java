...
public class LoginDao {
    public boolean validate(TransmissionRoles transmissionRoles) throws ClassNotFoundException {
        boolean status = false;

        Class.forName("com.mysql.jdbc.Driver");

        try (Connection connection = DriverManager
                .getConnection("jdbc:mysql://localhost:3306/txsis_registration?useSSL=false", "root", "");
